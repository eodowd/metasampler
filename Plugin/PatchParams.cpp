...
void AKSamplerParams::setDefaultValues()
{
    ...
    osc1.sfzName = "";
    osc1.pitchOffsetSemitones = 0.0f;
    osc1.detuneOffsetCents = 0.0f;//changed from zero
...
void AKSamplerParams::putXml(XmlElement* xml)
{
    ...
    osc1.detuneOffsetCents = (float)xml->getDoubleAttribute("osc1DetuneOffsetCents", 0.0);//changed from zero
